  ...
  return (
    <Container className="max-w-3xl text-center">
      ...
      <p>
        Please email us at{' '}
        <a
          href="mailto:allstartours.mb@gmail.com?subject=Booking%20Inquiry"
          className="text-bomber-gold underline"
        >
          {allStarToursEmail}
        </a>
      </p>
      <div className="mt-4">
        <div>
          <a className="text-bomber-gold underline" href={'tel:' + allStarToursPhone}>
            Call Us
          </a>
        </div>
      </div>
      <div className="mt-4">
        <p>
          <a
            ...
            rel="noreferrer"
          >
            Visit us on <span className="text-bomber-gold px-1 underline">Facebook</span>
      ...
      <div className="mt-4">
        <p className="text-xl font-semibold">
          To book a tour, Please download and fill out the following:
        </p>
        <a
          href={waiver}
          target="_blank"
          className="text-bomber-gold p-4 underline"
          rel="noreferrer"
        >
          Waiver form
        </a>
        ...
        <p className="font-semibold italic">
          A waiver form must be printed, signed and returned to us before the tour
        </p>
      </div>
    </Container>
  );
