...
export default function Book() {
  ...
  return (
    <Container className="max-w-3xl text-center">
      ...
      <div className="mt-4">
        <p>Or call us at <a href="tel:{allStarToursPhone}" rel="nofollow" className='underline text-bomber-gold'>{allStarToursPhone}</a></p>
      </div>
      <div className="mt-4">
        <p>
          <a
            ...
            rel="noreferrer"
          >Visit us on Facebook <svg className="w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
