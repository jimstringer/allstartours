...
export const Navbar = () => {
  return (
    <header className="bg-navbar sticky top-0 z-10 flex w-full flex-nowrap items-center justify-between px-4 md:px-8">
      <div className="flex h-24">
        <img className="" src={Logo} alt="logo" />
      </div>
      <nav className="flex items-center gap-4 text-xl font-medium md:gap-8 md:text-2xl">
